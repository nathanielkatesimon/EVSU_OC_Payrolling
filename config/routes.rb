Rails.application.routes.draw do
  ...
  patch '/cos_entries/calculate/:id' => 'cos_entries#calculate', as: 'calculate_cos_entry'
  ...
  patch '/regular_entries/calculate/:id' => 'regular_entries#calculate', as: 'calculate_regular_entry'
